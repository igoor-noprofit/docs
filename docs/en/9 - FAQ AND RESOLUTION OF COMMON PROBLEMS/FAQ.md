## General
**Q: What is IGOOR?**
A: IGOOR is a free/libre conversational application, controllable by mouse / touch / eye-tracking, designed for people with communication-impairing conditions such as ALS.

**Q: Is IGOOR free?**
A: **IGOOR is free, open-source, and libre software**. However, certain features currently depend on third-party providers that offer paid subscriptions.
...
**Q: I need help, I want to signal a bug in the app or in this doc: who shall I contact?
A: After reviewing this documentation, you can contact us directly at [support@igoor.org](mailto:support@igoor.org)

---
*This FAQ will continue to expand based on user feedback.*
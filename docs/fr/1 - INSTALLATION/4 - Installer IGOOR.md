...
a) créer un raccourci sur le bureau ;
...
A la fin de l'installation, vous pourrez directement démarrer IGOOR depuis son icône : allez au [[5 - Premier lancement]].

**IMPORTANT: Si vous rencontrez des problèmes d'installation : suivez [[RESOLUTION DES PROBLEMS COMMUNS]]**

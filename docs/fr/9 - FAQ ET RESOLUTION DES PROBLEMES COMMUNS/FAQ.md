...
R : IGOOR est une application conversationnelle open‑source, pilotable par souris ou commande oculaire, destinée aux personnes avec des pathologies qui impactent la communication, notamment la SLA.
...
**R: Vos mémoires sont stockées sur votre ordinateur**. Cependant, pour pouvoir fournir du contexte à l'IA qui génère vos prédictions, elles doivent être envoyées au fournisseur d'IA. Vous pouvez avoir d'autres informations sur Groq, le fournisseur d'IA open source que nous avons choisi, ici : [[2 - Préférences - IA]]

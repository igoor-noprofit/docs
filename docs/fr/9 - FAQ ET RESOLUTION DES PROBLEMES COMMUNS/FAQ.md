...
**R: Vos mémoires sont stockées sur votre ordinateur**. Cependant, pour pouvoir fournir du contexte à l'IA qui génère vos prédictions, elles doivent être envoyées au fournisseur d'IA. Vous pouvez avoir d'autres informations sur Groq, notre fournisseur d'IA open source par défaut, ici : [[2 - Préférences - IA]]

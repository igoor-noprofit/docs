...
R: Aujourd'hui, le seul élément indispensable est une clé du fournisseur Groq. 

**Q: Où sont stockées mes données ?**
**R: Vos données sont stockées sur votre ordinateur**. Cela inclut vos conversations, vos prédictions de mots et de phrases, 
Cependant, pour pouvoir fournir du contexte à l'IA qui génère vos prédictions, elles doivent être envoyées au fournisseur d'IA. Vous pouvez avoir d'autres informations sur Groq, notre fournisseur d'IA open source par défaut, ici : [[2 - Préférences - IA]]

...
Ces boutons sont TOUJOURS PRÉSENTS à l’écran, dans le bas de page de l'application. 

Le bouton tout à gauche réduit rapidement la fenêtre d'IGOOR, pour passer à un autre logiciel.
Les autres boutons, une fois activés, prononcent directement une phrase ou un son, sans besoin de clics supplémentaires. 

**Les phrases prononcées ne sont PAS intégrées à la conversation en cours** : le but est aussi de répondre à des besoins très urgents sans polluer la conversation en cours.

Le bouton ATTENDS permet de communiquer à l'interlocuteur que l'utilisateur est en train de lui répondre et a donc encore besoin d'un peu de temps.

Le bouton RÉPÉTER demande à l'interlocuteur de répéter sa question, parce que l'IA n'a pas correctement transcrit sa phrase.

...
**IGOOR** a été développé par l'[association loi 1901 IGOOR](https://igoor.org){target=blank}, en partenariat avec l'association [ARSLA](https://arsla.org){target=blank}.
L'application est actuellement en test à l'[Hopital Marin d'Hendaye](https://www.aphp.fr/hopitaux/hendaye){target=blank} avec des personnes qui souffrent de pathologies telles que la SLA et la SLP. IGOOR prend déjà en compte les premiers retours des patients qui l'ont utilisé.
